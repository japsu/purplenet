...
urlpatterns = patterns('',
    ...
    url(r'^manage/group/(?P<admin_group_id>\d+)/addorg/$',
        add_org_to_admin_group_page, name="add_org_to_admin_group_page"),
    url(r'^manage/group/(?P<admin_group_id>\d+)/removeorg/(?P<org_id>\d+)/$',
        remove_admin_group_from_org_page, name="remove_org_from_admin_group_page"),
